...
final groupBook = Group(
  ...
  name: 'LA 한국어 책 읽기 모임',
  description:
      '한인타운·인근 도서관에서 한국어 그림책·동화 같이 읽어요. '
...
final groupTorrance = Group(
  ...
  name: '토런스 초등맘 정보 모임',
  description:
      'Torrance·South Bay 초등 엄마들 정보 공유. '
...
final groupPasadena = Group(
  ...
  description:
      'Pasadena·Glendale 쪽 자연·하이킹·공원 놀이 모임. '
...
final groupOcPark = Group(
  ...
  name: 'OC 주말 놀이터 모임',
  description:
      'Irvine·Orange County 주말 놀이터 번개. '
      '워킹맘·전업맘 모두 환영이에요.',
  category: '야외·나들이',
  location: 'Irvine, Orange County',
...
final mockAllPosts = [...mockGroupPosts, ...mockGlobalPosts];
