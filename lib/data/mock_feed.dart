...
const postSeolleung = Post(
  ...
  authorName: '최유나',
  creatorId: 'mom_yuna',
  category: PostCategories.school,
  authorLocation: 'Koreatown',
  authorContext: '아이 4세',
  viewCount: 412,
  commentCount: 28,
  likeCount: 54,
...
const postIndoorSpots = Post(
  ...
  authorName: '한은지',
  creatorId: 'mom_eunji',
  category: PostCategories.parenting,
...
const postPediatrician = Post(
  ...
  authorName: '장하은',
  creatorId: currentUserId,
  category: PostCategories.health,
  authorLocation: 'Eagle Rock',
  authorContext: '아이 4세',
  viewCount: 478,
  commentCount: 31,
  likeCount: 65,
