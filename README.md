...
Version: **MVP 0.1** · Status: **Phase 3.8 — Home Group discovery (mock)**
...
- **Completed:** Phases 1–3.8 — foundation, docs pivot, local Groups / Events / RSVP, content-first Detail, async Group data flow, Home discovery
